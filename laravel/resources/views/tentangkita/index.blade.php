...
<section class="mb-20 text-gray-700">
  <div class="text-center md:max-w-xl lg:max-w-3xl mx-auto">
    <h3 class="text-3xl font-bold mb-6  text-gray-800 pt-1 md:pt-5">Kepengurusan  P4S Satria Tani Hanggawana </h3>
  ...
  <div class="container px-5 py-2 mx-auto lg:pt-5 lg:pb-10 lg:pl-96 lg:px-80">
    ...
    <div class="block rounded-lg shadow-md bg-white mr-8 ml-8 mb-3">
